...
**Stack:** Next.js 16 (App Router), TypeScript, Tailwind v4, Supabase with row-level security, Claude API. Auth and RLS get phased in deliberately per project rather than scaffolded on day one.
